...
insert into usuario (id, nome, login, senha, email, data_nascimento, status) values (3, 'Kaiki Mello', 'kaki', '123', 'kaiki@email.com', '1995-08-09', b'0');

insert into permissao_usuario (usuario_id, recurso_id) values (1, 1), (1, 2), (1, 3), (1, 4), (1, 5), (2, 2), (3, 1), (3, 2);
